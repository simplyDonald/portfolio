...
function Projects() {
  ...
  const projects = techStack.map((item) => {
    return (
      <div
        key={item.name}
        className="relative grid grid-cols-12 grid-rows-1 mb-10 h-fit border-2 border-red-500 "
      >
        <div className="col-start-1 col-end-8 text-center opacity-25 lg:opacity-100 row-span-1 row-start-1">
          <img
            src={item.img}
        ...
        <div className="col-start-1 col-end-8 row-start-1 font-body  grid grid-cols-1 lg:col-start-7 lg:col-end-13 z-10  ">
